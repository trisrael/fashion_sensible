	...
	public FemaleConfig() {
		...
		shapes = new Shape[28];
			try {
				...
				"female_images/female_blue_white.jpg"), f1colors, f1sizes, 79.90  );
				...
				"female_images/female_classy_blue.jpg"), f2colors, f2sizes, 59.90 );
				...
				"female_images/female_classy_grey.jpg"), f3colors, f3sizes, 89.90 );
				...
				"female_images/female_satin_pink.jpg"), f4colors, f4sizes, 59.90 );
				...
				"female_images/female_striped.jpg"), f5colors, f5sizes, 59.90 );
				...
				"female_images/female_classy_black.jpg"), f6colors, f6sizes, 79.90 );
				...
				"female_images/female_simple_offwhite_blue.jpg"), f7colors, f7sizes, 44.90 );
				...
				"female_images/female_farmer.jpg"), f9colors, f9sizes, 59.90 );
				...
				"female_images/female_blue_flowers.jpg"), f10colors, f10sizes, 45 );
				...
				"female_images/female_casual_black.jpg"), f11colors, f11sizes, 129.90 );
				...
				"female_images/female_school_girl.jpg"), f12colors, f12sizes, 109.90 );
				...
				"female_images/female_pink_brown.jpg"), f13colors, f13sizes, 49.90 );
				...
				"female_images/female_light_blue_red_string.jpg"), f14colors, f14sizes, 44.90 );
				...
				f15sizes.add("L" );
				f15sizes.add("XL" );
				shapes[14] = new ClothingItem(getClass().getResource("female_images/female_aztec.png"), f15colors, f15sizes, 59.90 );
				...
				f16sizes.add("M");
				f16sizes.add("L");
				shapes[15] = new ClothingItem(getClass().getResource("female_images/female_peasant.jpg"), f16colors, f16sizes, 109.90 );
				...
				f17sizes.add("M");
				f17sizes.add("XS");
				shapes[16] = new ClothingItem(getClass().getResource("female_images/female_grey_floopy.jpg"), f17colors, f17sizes, 89.90 );
				...
				f18sizes.add("M");
				f18sizes.add("XS");
				shapes[17] = new ClothingItem(getClass().getResource("female_images/female_multicolored.jpg"), f18colors, f18sizes, 81.90 );
				...
				f19sizes.add("L");
				f19sizes.add("XS");
				shapes[18] = new ClothingItem(getClass().getResource("female_images/female_sexy_offwhite.jpg"), f19colors, f19sizes, 95 );
				...
				f20sizes.add("S");
				f20sizes.add("XS");
				shapes[19] = new ClothingItem(getClass().getResource("female_images/female_leggings_black.jpg"), f20colors, f20sizes, 120 );
				...
				f21sizes.add("M");
				f21sizes.add("S");
				shapes[20] = new ClothingItem(getClass().getResource("female_images/female_swanky_blue.jpg"), f21colors, f21sizes, 77.44 );
				...
				f22sizes.add("S");
				f22sizes.add("XS");
				shapes[21] = new ClothingItem(getClass().getResource("female_images/female_flowered_red_blue.jpg"), f22colors, f22sizes, 88.90);
				...
				f23sizes.add("XL");
				f23sizes.add("XS");
				shapes[22] = new ClothingItem(getClass().getResource("female_images/female_china_blue.jpg"), f23colors, f23sizes, 65.90);
				...
				f24sizes.add("XS");
				f24sizes.add("L");
				shapes[23] = new ClothingItem(getClass().getResource("female_images/female_simple_white.jpg"), f24colors, f24sizes, 53);
				...
				f25sizes.add("S");
				f25sizes.add("L");
				shapes[24] = new ClothingItem(getClass().getResource("female_images/female_tube_brown.jpg"), f25colors, f25sizes, 65  );
				...
				f26sizes.add("S");
				f26sizes.add("XS");
				shapes[25] = new ClothingItem(getClass().getResource("female_images/female_muffin.jpg"), f26colors, f26sizes, 69);
				...
				f27sizes.add("XS");
				f27sizes.add("XL");
				shapes[26] = new ClothingItem(getClass().getResource("female_images/female_flowered_pink.jpg"), f27colors, f27sizes, 69);
				...
				f28sizes.add("S");
				f28sizes.add("L");
				shapes[27] = new ClothingItem(getClass().getResource("female_images/female_roses.jpg"), f28colors, f28sizes, 42);				
			} catch (IOException e) {
